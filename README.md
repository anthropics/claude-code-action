...
- This quickstart method is only available for direct Anthropic API users. For AWS Bedrock, Google Vertex AI, or Azure AI Foundry setup, see [docs/cloud-providers.md](./docs/cloud-providers.md).
...
- [Cloud Providers](./docs/cloud-providers.md) - AWS Bedrock, Google Vertex AI, and Azure AI Foundry setup
