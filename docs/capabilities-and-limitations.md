...
- **Run Arbitrary Bash Commands**: By default, Claude cannot execute Bash commands unless explicitly allowed via `claude_args` with `--allowedTools` (for example `claude_args: "--allowedTools Bash"`)
