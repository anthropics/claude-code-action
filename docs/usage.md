...
| `context_window`                 | Context window size. Use `1m` to enable the 1M token context window (beta, requires [usage tier 4](https://docs.anthropic.com/en/api/rate-limits)). Supported models: Claude Opus 4.6, Sonnet 4.6, Sonnet 4.5, and Sonnet 4 | No       | ""            |
