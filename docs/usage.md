...
| `allow_pr_rebase`                | Allow Claude to fetch, pull, and rebase the current PR branch after a non-fast-forward push. Only enable for trusted repositories and actors                                                                                          | No       | `false`                     |
