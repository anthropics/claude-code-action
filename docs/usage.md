...
| `bun_version`                    | Version of Bun to install when automatic Bun installation is used. Overrides the pinned default without requiring a separate setup-bun step                                                                                            | No       | `1.3.14`                    |
